...
# Welcome {.divider .center background-color="#06302F"}
...
## Two questions before we start {.hook background-color="#FAF7F2"}
...
## What the room said {.hook background-color="#FAF7F2"}
...
# 1 · The financial system {.divider .center background-color="#06302F"}

## Where does your salary sleep at night? {.hook background-color="#FAF7F2"}
...
## Ireland exports more than it makes {.hook background-color="#FAF7F2"}
...
<iframe width="540" height="250" src="https://www.youtube-nocookie.com/embed/qgmTZJIk7VE" title="Balance of payments" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; picture-in-picture" allowfullscreen data-external="1">
